<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- Grades-->
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Lecture-menu">
                <div class="pull-left"><i class="fas fa-school"></i><span
                        class="right-nav-text">{{trans('main_trans.lecture')}}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Lecture-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{route('video.index')}}">{{trans('main_trans.lecture_list')}}</a></li>
        ...
        <li>
            ...
            <ul id="Category-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{route('category.index')}}">{{trans('main_trans.Categories_list')}}</a></li>

            </ul>
        </li>

        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Type-menu">
                <div class="pull-left"><i class="fas fa-school"></i><span
                        class="right-nav-text">{{trans('main_trans.types')}}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Type-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{route('type.index')}}">{{trans('main_trans.type_list')}}</a></li>
