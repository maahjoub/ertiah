...
{{--  @include('layouts.student.student-header')--}}
  @include('layouts.student.student-header')
  @include('layouts.student.student-sidebar')
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="blog grid-blog">
                        ...
                        <div class="blog-content">
                            <h3 class="blog-title"><a href="blog-details.html">{{ $video->title }}</a></h3>
                            <p>{!! Str::words($video->description, 25, '' ) !!} </p>
                                ...
                                <div class="post-left">
                                    <ul>
                                        <li><a href="#."><i class="fa fa-calendar">
                                                </i> <span>{{$video->created_at->diffForHumans()}}</span></a></li>
                                    </ul>
                                </div>
