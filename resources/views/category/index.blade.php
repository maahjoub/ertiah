                        ...
                        <div class="col-xl-12 mb-30">
                            <div class="card card-statistics h-100">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <a href="{{ route('category.create') }}" class="button x-small" >
                                        {{ trans('main_trans.add_category') }}
                                    </a>
                                    <br><br>
                                    <div class="table-responsive">
                                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                                            ...
                                            <tr>
                                                ...
                                                <th>#</th>
                                                <th>{{ trans('main_trans.Category_name') }}</th>
                                            ...
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" class="btn btn-info btn-sm" href="{{ route('category.edit', $category->id) }}"
                                                        ...
                                                        <form action="{{ route('category.destroy', $category->id) }}" class="d-inline"
                                                            ...
                                                            @csrf
                                                                <button type="submit"
                                                                        class="btn btn-danger"><i class="fa fa-trash"></i></a></button>
                                                        </form>
                                                    </td>
                                                </tr>
